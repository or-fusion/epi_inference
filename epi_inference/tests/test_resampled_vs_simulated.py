...
class TestRunOnSimulated():
    ...
    def test_run_on_simulated(self):
        args = Options()
        args.block = 'all'
        args.config_file = './workflows/resampled_vs_simulated.yml'
        args.verbose = True

        # remove old results files used in comparison
        res_files = _walk_files('results/resampled_vs_simulated', '.json')
        for f in res_files:
            os.remove(os.path.join('results/resampled_vs_simulated', f))
        res_files = _walk_files('results/resampled_vs_simulated', '.csv')
        for f in res_files:
            os.remove(os.path.join('results/resampled_vs_simulated', f))
        ...
        recon = dict()
        for sd in seeds:
            with open('./results/resampled_vs_simulated/reconstruct_resampled_confirmed/recon_resampled_10_{}.json'.format(str(sd)),'r') as fd:
        ...
        inference = dict()
        for sd in seeds:
            with open('./results/resampled_vs_simulated/inference_resampled_confirmed/inference_mobility_window_10_{}.json'.format(str(sd)),'r') as fd:
        ...
        #
        res_json_files = _walk_files('results/resampled_vs_simulated', '.json')
        ...
        for f in res_json_files:
            ...
            if f in baseline_json_files:
                ...
                res_file = os.path.join('results/resampled_vs_simulated', f)
        ...
        #
        res_csv_files = _walk_files('results/resampled_vs_simulated', '.csv')
    ...
    def test_run_on_simulated_half(self):
        args = Options()
        args.block = 'all'
        args.config_file = './workflows/resampled_vs_simulated_half.yml'
        args.verbose = True

        # remove old results files used in comparison
        res_files = _walk_files('results/resampled_vs_simulated_half', '.json')
        for f in res_files:
            os.remove(os.path.join('results/resampled_vs_simulated_half', f))
        res_files = _walk_files('results/resampled_vs_simulated_half', '.csv')
        for f in res_files:
            os.remove(os.path.join('results/resample_vs_simulated_half', f))
        ...
        # compare all the json files (gold standard)
        #
        res_json_files = _walk_files('results/resampled_vs_simulated_half', '.json')
        ...
        for f in res_json_files:
            ...
            if f in baseline_json_files:
                baseline_json_files.remove(f)
                res_file = os.path.join('results/resampled_vs_simulated_half', f)
        ...
        # compare all the csv files (gold standard)
        #
        res_csv_files = _walk_files('results/resampled_vs_simulated_half', '.csv')
